...
configure a Cloudflare D1 development binding and apply the SQL migration under
`drizzle/`.
...
- **Save view** stores the current filters and selected playlist in that
  browser's local storage.
- **Export CSV** downloads the currently filtered records.
- The source archive contains the application, schema, migrations, seed data,
  and this guide. It intentionally excludes dependencies and generated builds.
